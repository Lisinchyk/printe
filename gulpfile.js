...
const paths = {
    ...
    stylesheets: {
        src: srcBase + "assets/scss/main.scss",
    ...
    img: {
        src: srcBase + "assets/images/**/*.{png,gif,jpg,bmp,tiff,jpeg,webp}",
        dest: destBase + "assets/images/"
    },
...
function jsExternal() {
    ...
    return gulp.src(paths.js.srcExternal, {
            since: gulp.lastRun(jsExternal)
        })
        .pipe(gulp.dest(paths.js.dest));
}
 ...
 */
function watchCss() {
    return gulp.watch(`${srcBase}assets/scss/**/*.scss`, css);
}
...
function watchHtml() {
    return gulp.watch([`${srcBase}*.html`, `${srcBase}pages/**/*.html`], html);
}
...
exports.build = gulp.parallel(css, jsMain, jsExternal, html, images, copyOther, fonts);
